                                ...
                                <form action="{{ route('customer.savePayment') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="transfer_to" class="form-control" required>
                                            ...
                                            <option value="BCA - 1234567">BCA: 1234567 a.n Nurlaila</option>
                                            <option value="Mandiri - 2345678">Mandiri: 2345678 a.n Nurlaila
                                            </option>
                                            <option value="BRI - 9876543">BCA: 9876543 a.n Nurlaila</option>
                                            <option value="BNI - 6789456">BCA: 6789456 a.n Nurlaila</option>
                                        </select>
